...
<body id="error">	
	<div class="error_text_box">
		<i></i>
		<em>본인인증된 정보로는 삼성증권 고객으로 확인되는 사항이 없습니다.</em>
		만약, "삼성증권에 계약이 분명 있는데?" 라고 생각하신다면, 아래의 방법 중 1가지로 확인하여 주시기 바랍니다.<br /><br />
		1. 대표홈페이지 간편로그인 후 보험계약조회 진행하기<br />
		2. 대표콜센터 (1688-1688)로 문의하기<br />
		※ 콜센터 운영시간 : 평일 오전 9시~오후 6시
		<br />
		<a href="javascript:_close();">닫기</a>
	</div>
</body>
