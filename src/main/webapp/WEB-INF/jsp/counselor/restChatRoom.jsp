...
<%@ taglib uri="https://happytalk.io/jsp/jstl/chat" prefix="chat" %>
	<div class="inner">
		<div class="popup_head"><%--
			<button type="button" class="btn_view_allcounseling"><i></i>전체</button>--%>
			...
			<div class="counseling_mid">
				...
				<div class="chatting_area">
					...
					<c:forEach var="chatMessage" items="${chatRoom.chatMessageList}" varStatus="i"><%--
						...
						<div data-message-id="${chatMessage.chatNum}" data-message-sender="${chatMessage.senderUid}" class="message_box ${chatMessage.messageClassName}">
								...
								<article class="inner-chat">
									...
									<%-- 	<c:if test="${!empty chatMessage.avatarClassName}">
										...
										<%-- <div class="${chatMessage.messageBoxClassName}"> --%>
											...
											<div class="time-chat"><c:out value="${chatMessage.regDtPretty}" /></div>
										<!-- </div> -->
									</div>
								</article>
							</div>
					...
					<!-- 						<div data-message-id="741121" data-message-sender="9999999991" class="message_box right-chat-wrap">
							<div class="bubble-wrap green">
								<article class="inner-chat">
									<div class="bubble-round">
										<div class="mch type_text highlighted">F1 상담직원1 상담직원을 연결해 드리겠습니다. 문의내용 확인 후 답변드리겠습니다. 잠시만 기다려주세요~</div>
										<div class="time-chat">오전 10:09</div>
									</div>
								</article>
							</div>
						</div> -->
			...
			<div class="counseling_info_right">
				<table class="tCont">
					...
					<tbody>
						...
						<tr>
							<th>평가내용</th>
							<td class="textL">${chatRoom.evlCont}
							</td>
						</tr>
						<tr>
							<th>인증고객명</th>
