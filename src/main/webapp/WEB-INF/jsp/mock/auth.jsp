...
<body id="admin">
	...
	<div class="certification contents step3">
		...
		<div>
			<div class="subText">
				<p class="normal">ㆍ아래 <span class="bold">“확인”</span> 버튼을 눌러서 챗봇 대화창으로 이동하신 후<br><span class="point">대화창 내 <span class="bold">“인증 완료했어요!”</span>를 꼭~ 선택해 주세요.</span></p>
		...
		<!--div>
			<div class="subText">
				<p class="normal">ㆍ아래 <span class="bold">“확인”</span> 버튼을 눌러서 채팅 대화방으로 이동하시면<br><span class="point">상담직원과 대화가 가능합니다.</span></p>
			</div>
		</div-->
		<!--채팅상담 진입시 -->
