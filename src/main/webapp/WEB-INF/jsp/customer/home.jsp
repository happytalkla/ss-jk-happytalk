...
<body id="chat" class="layer-on">
			...
			<div class="chat-top-inner">
				...
				<div class="left">
					...
					<c:choose>
						...
						<c:when test="${user.cstm_link_div_cd == 'C'}"><span class="tit-h1">챗봇상담</span></c:when>
						<c:when test="${user.cstm_link_div_cd == 'D'}"><span class="tit-h1">업무상담</span></c:when>
						<c:when test="${user.cstm_link_div_cd == 'E'}"><span class="tit-h1">업무상담</span></c:when>
						<c:otherwise><span class="tit-h1">업무상담</span></c:otherwise>
					</c:choose>
					</h1>
				</div>
				<div class="right">
					...
					<c:if test="${!hideEndBtn}">
						<span class="dptable btn_chat_search"><a href="javascript:void(0);" class="btn_close_chat" title="채팅 종료하기">종료</a></span>
					</c:if>
				</div>
				<!-- 
		...
		<div id="chat_bottom" class="chat-bottom">
			<div class="qna-line-wrap type-ing">
				...
				<div class="inner">
					...
					<c:if test="${ entityId == '1005882331' || entityId == '1007736116' || entityId == '1000721320' || entityId == '1006124397'}">
				...
				<!-- 종료 -->
				<div class="inner review_inner" id="review_inner" style="display:none;">
	...
	<!-- <a href="javascript:void(0);" class="to-the-up">위로 이동</a> -->
...
<form id="user" style="display: none;">
	...
	<input type="hidden" name="departCd" value="${ user.departCd }" />
</form>
<!--[if lt IE 9]>
...
////////////////////////o2  ////////////////////////////// 
	...
	function appToWeb(data){
		...
		alert("[[O2]] data.comKey : " + data.comKey + " >>> send status : " + userStatus);
		</c:if>
	}
