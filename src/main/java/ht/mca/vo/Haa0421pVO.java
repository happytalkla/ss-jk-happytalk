 ...
 * Customization : FALSE
 */ 
public class Haa0421pVO extends VOSupport {
	...
	/* constructor */
	public Haa0421pVO (String ipAddr, String userID, String mediaType) {
	...
	/* constructor */
	public Haa0421pVO (String ipAddr, String userID, String mediaType, String brchCD, String deptCD, String acctCD) {
		setHeaderUserID(userID);
		setHeaderTrCode("maa0421p");
		setHeaderDestination((char)'6');
		setHeaderPacketDataType((char)0);
