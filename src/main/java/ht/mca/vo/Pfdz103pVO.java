 ...
 *
 */
public class Pfdz103pVO extends VOSupport {
	...
	public static class InRec1 {
		...
		private String H_ipswd_cryp; /* 비밀번호암호문 */
	...
	/* constructor */
	public Pfdz103pVO (String ipAddr, String userID, String mediaType) {
		setHeaderUserID(userID);
		setHeaderTrCode("pfdz103p");
	...
	/* constructor */
	public Pfdz103pVO (String ipAddr, String userID, String mediaType, String brchCD, String deptCD, String acctCD) {
		setHeaderUserID(userID);
		setHeaderTrCode("pfdz103p");
		setHeaderDestination((char)'6');
		setHeaderPacketDataType((char)0);
	...
	public byte[] getBytes() throws Exception {
		...
		if (needCert()) {
			...
			if (inRec1.getPText() != null) {
				...
				MCAUtil.writeString(inRec1.H_ipswd_cryp, 44, bos);
			}			
		}
